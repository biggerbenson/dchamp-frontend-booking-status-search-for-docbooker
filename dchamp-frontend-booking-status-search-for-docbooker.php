<?php
/**
 * Plugin Name: Dchamp Frontend Booking Status Search for DocBooker
 * Plugin URI: https://dchamplegacy.com/plugins/docbooker-search/
 * Description: Frontend booking status search for DocBooker sites. Visitors can search by Booking ID only and view Booking ID, Patient Name, Status, and Present Status without changing any booking data.
 * Version: 1.2.2
 * Author: Dchamp Legacy
 * Author URI: https://dchamplegacy.com/
 * License: GPL-2.0-or-later
 * License URI: https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain: frontend-booking-status-search-for-docbooker
 */
